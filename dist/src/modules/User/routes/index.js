...
class UserRoute {
    ...
    initializeRoutes() {
        ...
        this.router.patch(`${this.path}/update/:id`, (0, validation_middleware_1.ValidationMiddleware)(update_user_dto_1.UpdateUserDto), this.User.update);
        this.router.get(`${this.path}/:id`, this.User.findOne);
